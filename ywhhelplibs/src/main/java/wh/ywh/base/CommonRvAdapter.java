...
public abstract  class CommonRvAdapter<T>  extends RecyclerView.Adapter<CommonRvAdapter.CommonViewHolder> implements View.OnClickListener, View.OnLongClickListener {
    ...
    private OnRvClickListener mListener;
    private OnRvLongClickListener mLongListener;
    ...
    public CommonRvAdapter(int layoutId, List<T> data){
        if(layoutId == 0){
...
//        LogUtil.i(""+headView==null?true:false+",pos:"+position);
    ...
    public void setOnItemClicked(OnRvClickListener listener){
        this.mListener = listener;
    }
    public void setOnItemLongClicked(OnRvLongClickListener listener){
