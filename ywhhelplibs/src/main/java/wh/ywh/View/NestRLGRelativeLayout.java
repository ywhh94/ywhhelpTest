...
public class NestRLGRelativeLayout extends LinearLayout {
    private boolean isIntercept;//是否被拦截
    private Map<View,Boolean> map;

    public NestRLGRelativeLayout(Context context) {
        super(context);
        map = new HashMap<>();
    }

    public NestRLGRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        map = new HashMap<>();
    }

    public NestRLGRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
