...
public class PickerScrollView extends View {
	...
	private void drawData(Canvas canvas) {
		...
		LogUtil.e("mMaxTextSize:"+mMaxTextSize);
		LogUtil.e("mMinTextSize:"+mMinTextSize);
		LogUtil.e("scale:"+scale);
		mPaint.setTextSize(size);
		mPaint.setColor(mDataList.get(mCurrentSelected).getColor());
		...
		float textHeight = fontMetrics.descent - fontMetrics.leading - fontMetrics.ascent;//文字高度

		canvas.drawLine(0, getHeight()/2, getWidth(), getHeight()/2, new Paint());
		canvas.drawLine(0, baseline, getWidth(), baseline, new Paint());
		// 绘制上方data
