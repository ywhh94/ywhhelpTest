package com.leoman.helper.pickerview.view;

import android.view.View;

import com.leoman.helper.R;
import com.leoman.helper.pickerview.TimePickerView.Type;
import com.leoman.helper.pickerview.adapter.NumericWheelAdapter;
...
public class WheelTime {
    ...
    private Type type;
    public static final int DEFULT_START_YEAR = 1880;
...
//		wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字
    ...
    public String getTime() {
        ...
        sb.append((wv_year.getCurrentItem() + startYear)).append("年")
